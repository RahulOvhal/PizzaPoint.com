            ...
            <Container>
                <Row className="align-items-center">
                    <Col lg={6} className='text-center text-lg-start mb-5 mb-lg-0'>
                        ...
                        <h2>Save upto 20%</h2>
                        <p>
                        Customize your pizza to your heart's content, choosing from an array of toppings, sauces, and crusts.
                        </p>
                        <Link to="/">
                    ...
                    <Col lg={6}>
                        <img src={DownloadImage} className='img-fluid e_shop' alt="e_shop"/>
                    </Col>
                </Row>
            </Container>
        </section> 
